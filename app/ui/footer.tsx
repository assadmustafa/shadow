...
const Footer = () => {
  return (
    <footer className="relative w-full bg-blue-600 clear-both">
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm sm:text-center text-blue-300">
            © 2023{" "}
            <a href="/" className="hover:text-white transition duration-500">
              Shadow™
            </a>
          ...
          <div className="flex mt-4 sm:justify-center sm:mt-0">
            <a
              href="#"
              className="text-blue-300 hover:text-white transition duration-500"
            >
              <svg
                className="w-4 h-4"
                aria-hidden="true"
            ...
            <a
              href="#"
              className="text-blue-300 hover:text-white transition duration-500 ms-5"
            >
              <svg
                className="w-4 h-4"
                aria-hidden="true"
